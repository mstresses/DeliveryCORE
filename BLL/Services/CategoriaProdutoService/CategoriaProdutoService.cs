...
{
    public class CategoriaProdutoService : CategoriaDeProdutosValidator, ICategoriaProdutoService
    {
        private ICategoriaDeProdutoRepository _produtoRepository;

        public CategoriaProdutoService(ICategoriaDeProdutoRepository produtoRepository)
        {
