...
namespace DeliveryCORE
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<DeliveryContext>(c => c.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=DeliveryCoreDB;Integrated Security=True;Connect Timeout=30"));
